package com.petproject.server.config;

import com.petproject.server.security.jwt.JwtConfigurer;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String REGISTRATION_ENDPOINT = "/auth/sign-up/";
    private static final String NOTE_ENDPOINTS = "/notes/**";
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers(NOTE_ENDPOINTS).hasRole("USER")
